...
class BriansBrainAutomata:
    ...
    def define_palette(self):
        return [
            (33, 5, 5),       # Off
            (255, 255, 255),      # On
            (227, 188, 207),     # Dying level 1
            (199, 121, 159),    # Dying level 2
            (171, 55, 112),     # Dying level 3
            (172, 37, 75),     # Dying level 4
            (173, 19, 38),      # Dying level 5
            (175, 1, 1),      # Dying level 6
            (150, 5, 5),     # Dying level 7
            (125, 10, 10),     # Dying level 8
            (66, 10, 10)        # Dying level 9
        ]
